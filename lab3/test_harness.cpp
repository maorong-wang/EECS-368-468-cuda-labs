...
int main(int argc, char* argv[])
{
    ...
    uint32_t *temp_bin;    
    opt_2dhisto_init(input,device_input,device_bin,temp_bin);
    /* End of setup code */

    /* This is the call you will use to time your parallel implementation */
    TIME_IT("opt_2dhisto",
            1000,
            opt_2dhisto(device_input,device_bin,temp_bin);)

    /* Include your teardown code below (temporary variables, function calls, etc.) */
    opt_2dhisto_finalize(device_input,device_bin,temp_bin,kernel_bins);
